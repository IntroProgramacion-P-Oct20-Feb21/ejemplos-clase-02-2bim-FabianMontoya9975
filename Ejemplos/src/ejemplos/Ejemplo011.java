/*
    ...
    Estudiante:Luis - M1: 8,1000 M2: 7,9000 PROM: 8,0000
    Estudiante:Ana - M1: 9,0000 M2: 9,2000 PROM: 9,1000
    Estudiante:Mónica - M1: 9,5000 M2: 9,7000 PROM: 9,6000
    Estudiante:José - M1: 10,0000 M2: 9,8000 PROM: 9,9000
    Estudiante:Juan - M1: 9,9000 M2: 9,7000 PROM: 9,8000
 */
package ejemplos;
...
public class Ejemplo011 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < promediosMateria1.length; i++) { 
            ...
            mensajeFinal = String.format("%sEstudiante:%s - M1: %.4f M2: %.4f "
                    + "PROM: %.4f\n", 
                    mensajeFinal,
                    estudiantes[i],
                    promediosMateria1[i],
